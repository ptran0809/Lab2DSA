...
public class Song implements copyable {
	...
	public boolean equals(Song s) {
		return (this.songName.compareToIgnoreCase(s.getSongName()) == 0
				&& this.artist.compareToIgnoreCase(s.getArtist()) == 0 && this.playtime == s.getPlaytime());
	}
	...
	@Override
	public Object copy() {
		return new Song(this.songName, this.artist, this.playtime);
